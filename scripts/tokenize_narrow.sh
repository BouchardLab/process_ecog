...
#srun -N 1 -n 1 -c "$cores" python -u tokenize_data.py /project/projectdirs/m2043/jlivezey/EC9 60 63 --zscore 'file' --data_type AA_avg --align_pos 1 --output_folder $SCRATCH/output &
